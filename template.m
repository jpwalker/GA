...
model.component('comp1').selection.duplicate('box4', 'box1');
...
model.component('comp1').geom('geom1').feature('cyl1').set('r', '75[nm]');
model.component('comp1').geom('geom1').feature('cyl1').set('h', 'cu_z');
model.component('comp1').geom('geom1').feature('blk3').set('contributeto', 'none');
model.component('comp1').geom('geom1').feature.duplicate('cyl2', 'cyl1');
model.component('comp1').geom('geom1').feature('cyl2').set('r', '65[nm]');
model.component('comp1').geom('geom1').feature('cyl2').set('pos', {'0' '0' '-cu_z/2'});
model.component('comp1').geom('geom1').feature('cyl1').set('pos', {'0' '0' '-cu_z/2'});
model.component('comp1').geom('geom1').run('cyl2');
model.component('comp1').geom('geom1').create('dif1', 'Difference');
model.component('comp1').geom('geom1').feature('dif1').label('Copper 1');
...
model.component('comp1').geom('geom1').feature('dif1').selection('input').remove({'cyl2'});
...
model.component('comp1').geom('geom1').feature('cyl3').set('h', 'cu_z');
model.component('comp1').geom('geom1').feature('cyl3').set('r', 95);
model.component('comp1').geom('geom1').feature('cyl3').set('pos', {'0' '0' '-cu_z/2'});
...
model.component('comp1').geom('geom1').feature('dif2').label('Copper 2');
model.component('comp1').geom('geom1').feature('dif2').set('contributeto', 'csel3');
model.component('comp1').geom('geom1').run('dif2');
model.component('comp1').geom('geom1').create('dif3', 'Difference');
model.component('comp1').geom('geom1').feature('dif3').label('Air Block');

model.component('comp1').view('view1').hideObjects.clear;

model.component('comp1').geom('geom1').feature('dif3').selection('input').set({'blk3'});
model.component('comp1').geom('geom1').feature('dif3').selection('input2').named('csel3');
model.component('comp1').geom('geom1').feature('dif3').set('keep', true);
model.component('comp1').geom('geom1').feature('dif3').set('contributeto', 'csel2');
model.component('comp1').geom('geom1').run('dif3');
model.component('comp1').geom('geom1').create('del1', 'Delete');
model.component('comp1').geom('geom1').feature('del1').selection('input').init;
model.component('comp1').geom('geom1').feature('del1').selection('input').set({'dif3'});
model.component('comp1').geom('geom1').feature('del1').selection('input').init;
